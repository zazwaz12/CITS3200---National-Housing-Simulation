...
if __name__ == '__main__':
    new_df = standarise_names(read_spreadsheets(
        ...
        read_spreadsheets('C:/Users/IamNo/Desktop/DataFiles/FilesIn/census'
                          '/Metadata/Metadata_2021_GCP_DataPack_R1_R2.xlsx', 'xlsx')[
            "Metadata_2021_GCP_DataPack_R1_R2.xlsx"]['Cell Descriptors Information'],
