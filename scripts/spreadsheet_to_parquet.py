...
def main():
    ...
    parser.add_argument("input", default= os.path.normpath("./FilesIn"),type=str, help="Input Directory")
    parser.add_argument("output", default= os.path.normpath("./Appstaging"),type=str, help="Output Directory")
