...
class GeoSeries(GeoPandasBase, Series):
    ...
    def __init__(
        self, data=..., index=..., crs: Optional[Any] = ..., **kwargs
    ) -> None: ...
    ...
    @classmethod
    def from_wkb(cls, data, index=..., crs: Optional[Any] = ..., **kwargs) -> GeoSeries:
        """
    ...
    @classmethod
    def from_wkt(cls, data, index=..., crs: Optional[Any] = ..., **kwargs) -> GeoSeries:
        """
        Alternate constructor to create a ``GeoSeries``
    ...
    @classmethod
    def from_xy(cls, x, y, z=..., index=..., crs=..., **kwargs) -> GeoSeries:
        """
...
3.0, 3.0, 3.0)}], 'bbox': (1.0, 1.0, 3.0, 3.0)}
    ...
    @doc(pd.Series)
    def apply(self, func, convert_dtype: bool = ..., args=..., **kwargs): ...
    ...
    def fillna(self, value=..., inplace: bool = ..., **kwargs):
        """
    ...
    def explode(self, ignore_index=..., index_parts=...) -> GeoSeries:
        """
    ...
    def to_crs(self, crs: Optional[Any] = ..., epsg: Optional[int] = ...) -> GeoSeries:
    ...
    def estimate_utm_crs(self, datum_name: str = ...) -> CRS:
...
0]}, "bbox": [3.0, 3.0, 3.0, 3.0]}], "bbox": [1.0, 1.0, 3.0, 3.0]}'
    ...
    def to_wkb(self, hex: bool = ..., **kwargs) -> Series:
        """
    ...
    def clip(self, mask, keep_geom_type: bool = ...) -> GeoSeries:
